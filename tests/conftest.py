...
def override_stock_movement_use_cases(db_session):
    ...
    overrides = {
        ...
        stock_movement_container.delete_stock_movement: test_container.delete_stock_movement,
        stock_movement_container.get_sales_summary: test_container.get_sales_summary,
    }
    app.dependency_overrides.update(overrides)
